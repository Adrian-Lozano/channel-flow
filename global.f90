...
Module global
  ...
  ! constant mass flow
  Real   (Int64) :: Qflow_x_0, Qflow_y_0, Ucenterline_x
  ...
  Real   (Int64), Allocatable, Dimension(:,:,:,:) :: LWij, MWij, MWij2, SWij
  Real   (Int64), Allocatable, Dimension(:,:,:)   :: Uf, Vf, Wf, S
  Real   (Int64), Allocatable, Dimension(:,:,:)   :: Uff, Vff, Wff, Ufff, Vfff, Wfff
  Real   (Int64), Allocatable, Dimension(:,:,:)   :: nu_t, avg_nu_t, avg_nu_t_hat, nu_t_hat
  Real   (Int64) :: fil_size, fil_size_2, Delta

  ! channel spanwise rotation
  Real(Int64) :: Omega_z

  ! wall-model
  Integer(Int32) :: penetration, iwall_model, jref_eqwm, n_nan_eqwm, n_iter_eqwm, est_Tij
  Integer(Int32) :: gwm_cu, gwm_c_test, gwm_diag, gwm_ai(6)
  Real   (Int64) :: alpha_mean_x, alpha_mean_y, alpha_mean_z, freq_mult, alpha_std, int_len
  Real   (Int64) :: mean_alpha_x, mean_alpha_y, mean_alpha_z 
  Real   (Int64) :: tau_mean_eqwm
  Real   (Int64), Allocatable, Dimension(:,:,:) :: alpha_x, alpha_y, alpha_z, alpha_z_temp
  Real   (Int64), Allocatable, Dimension(:,:,:) :: temp_1, temp_2, temp_3, temp_4, tau_eqwm_initial
